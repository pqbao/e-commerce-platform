            ...
            <form className="row mb-2" onSubmit={handleSubmit}>
                <div className="col-12">
                    <Input
                        ...
                        feedback='Vui lòng cung cấp địa chỉ số nhà/ tên đường hợp lệ'
                        validator="address"
                        onChange={(value) =>
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback='Vui lòng cung cấp địa chỉ phường/ xã hợp lệ'
                        validator="address"
                        onChange={(value) =>
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback='Vui lòng cung cấp địa chỉ quận/ huyện hợp lệ'
                        validator="address"
                        onChange={(value) =>
                            handleChange(
                                'district_city',
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback='Vui lòng cung cấp địa chỉ tỉnh/ thành phố hợp lệ'
                        validator="address"
                        onChange={(value) =>
                            handleChange(
                                'city_province',
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback='Vui lòng cung cấp quốc gia hợp lệ'
                        validator="address"
                        onChange={(value) =>
