        ...
        <div className="position-relative">
            ...
            >
                <div className="col-12 bg-primary p-3">
                    <Logo />
                    <p className="text-white fw-light">Thông tin người nhận hàng</p>
                </div>
                ...
                <div className="col-xl-6 col-md-6">
                    <div className="my-2 p-2 border border-primary rounded">
                        <h5 className="text-center">Thiết lập thanh toán</h5>
                        <hr />

                        <dl className="row">
                            <dt className="col-sm-3 col-6">Tổng tiền sản phẩm</dt>
