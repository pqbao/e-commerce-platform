...
import { humanReadableDateSub } from '../../helper/humanReadable';
...
const ReviewInfo = ({ review = {}, about = true, onRun }) => {
    ...
    return (
        <div className="row py-2 border border-primary rounded-3 position-raletive bg-body">
            {isloading && <Loading />}
            ...
            <div className="col-12 mx-2 d-flex justify-content-between align-items-center">
                <div className="d-flex justify-content-between align-items-center flex-grow-1">
                    ...
                    <span className='me-4 mt-2 text-secondary'>{humanReadableDateSub(review.createdAt)}</span>
                </div>
