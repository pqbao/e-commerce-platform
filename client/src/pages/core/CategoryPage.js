...
import ProductFilterCategory from '../../components/filter/ProductFilterCategory';
...
const CategoryPage = (props) => {
    ...
    return (
        <MainLayout>
            <div className='row'>
                <div className='col-md-2 bg-white rounded p-3 sticky-scroll'>
                    <div className="mb-4">
                    ...
                    <div>
                        <ProductFilterCategory filter={filter} setFilter={setFilter} />
                    </div>
                </div>
